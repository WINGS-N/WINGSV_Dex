...
var file_appcontrol_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
...
func file_appcontrol_proto_init() {
	...
	file_appcontrol_proto_msgTypes[12].OneofWrappers = []any{
	...
	file_appcontrol_proto_msgTypes[20].OneofWrappers = []any{}
	type x struct{}
